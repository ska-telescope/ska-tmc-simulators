...
##       HELM_BUILD_PUSH_SKIP=[yes|<empty>] - Flag to skip publish to GitLab repository
##       VERSION=<semver tag of helm charts> - defaults to release key in .release file
##       HELM_REPOSITORY_URL=<repository URL to publish to> - defaults to https://gitlab.com/api/v4/projects/${CI_PROJECT_ID}/packages/helm/api/${HELM_CHARTS_CHANNEL}/charts
